            ...
            <div className="flex h-full flex-1 flex-col gap-6 p-4 sm:p-6">
                ...
                <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                    <div>
                        ...
                        <p className="text-sm text-muted-foreground mt-1">
                            Kelola matriks tingkat akses (Roles) dan batasan fitur sistem (Permissions).
                        </p>
                    </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                    <div className="p-4 rounded-xl border border-sidebar-border bg-card shadow-sm flex items-center gap-3">
                        ...
                        <div>
                            <div className="text-xs text-muted-foreground font-medium">Total Role System</div>
                            <div className="text-xl font-extrabold text-foreground">{roles.length}</div>
                        </div>
                    </div>
                    ...
                    <div className="p-4 rounded-xl border border-sidebar-border bg-card shadow-sm flex items-center gap-3">
                        ...
                        <div>
                            <div className="text-xs text-muted-foreground font-medium">Fitur Permissions</div>
                            <div className="text-xl font-extrabold text-foreground">{permissions.length}</div>
                        </div>
                    </div>
                    ...
                    <div className="p-4 rounded-xl border border-sidebar-border bg-card shadow-sm flex items-center gap-3">
                        ...
                        <div>
                            <div className="text-xs text-muted-foreground font-medium">Pengguna Terdistribusi</div>
                            <div className="text-xl font-extrabold text-foreground">
                                {roles.reduce((acc, r) => acc + r.users_count, 0)}
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="grid md:grid-cols-3 gap-6">
                    {roles.map((r) => (
                        <div 
                            key={r.id}
                            className="p-6 rounded-2xl border border-sidebar-border bg-card hover:border-primary/40 transition-all flex flex-col justify-between shadow-sm relative group"
                        >
                            <div>
                                <div className="flex items-center justify-between mb-4">
                                    <div className="flex items-center gap-3">
                                        <div className="w-10 h-10 rounded-xl bg-gradient-to-tr from-primary/20 to-primary/10 text-primary flex items-center justify-center border border-primary/20">
                                            <Shield className="w-5 h-5" />
                                        </div>
                                        <div>
                                            ...
                                            <span className="text-xs text-muted-foreground flex items-center gap-1">
                                                ...
                                                <span>{r.users_count} User Terdaftar</span>
                                            </span>
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex flex-wrap gap-1.5">
                                        {r.permissions.length > 0 ? (
                                            r.permissions.map((p, i) => (
                                                <span 
                                                    key={i}
                                                    className="inline-flex items-center gap-1 px-2.5 py-1 rounded-md text-xs font-semibold bg-muted text-foreground border border-sidebar-border"
                                                >
                            ...
                            <div className="pt-4 border-t border-sidebar-border flex items-center justify-between text-xs text-muted-foreground">
